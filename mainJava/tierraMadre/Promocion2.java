...
public class Promocion2 {
		...
		public Promocion2(int id, String nombre) {
			this.idPromo = id;
			this.nombrePromo = nombre;
		}

		public Promocion2(int id, TipoPromo tipoPromo, String nombre, int idAtr1, int idAtr2) {
			this.idPromo = id;
		...
		public Promocion2(int id, TipoPromo tipoPromo, String nombre, int idAtr1, int idAtr2, int idAtr3) {
			this.idPromo = id;
			this.tipoPromo = tipoPromo;
			this.nombrePromo = nombre;
			this.id_Atraccion1 = idAtr1;
		...
		public Promocion2(String nombre, List<Atraccion> atracciones2, double montoPromo, TipoPromo tipo) {
		}
