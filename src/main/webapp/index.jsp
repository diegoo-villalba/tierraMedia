    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" align="center">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <img src="img/plancha.jpg" width="500" height= "500" class="d-block w-50" alt="...">
          ...
          <div class="carousel-item">
            <img src="img/planchaq.jpg" height= "500" class="d-block w-50" alt="...">
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="img/plancha3.jpg" height= "500" class="d-block w-50" alt="...">
            <div class="carousel-caption d-none d-md-block">
